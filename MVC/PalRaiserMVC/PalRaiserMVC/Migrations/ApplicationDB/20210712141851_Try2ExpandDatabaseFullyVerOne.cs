...
{
    public partial class Try2ExpandDatabaseFullyVerOne : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopicReplyId = table.Column<int>(type: "int", nullable: false),
                    TopicId = table.Column<int>(type: "int", nullable: false),
                    TopicReplyId1 = table.Column<int>(type: "int", nullable: true),
                    TopicReplyTopicId = table.Column<int>(type: "int", nullable: true),
                    IsLike = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
